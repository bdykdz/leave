...
const AVAILABLE_FIELDS = {
  ...
  leave: {
    ...
    fields: [
      ...
      { key: 'leave.dates', label: 'Leave Dates (Range)', type: 'text' },
      { key: 'leave.isAnnualLeave', label: 'Is Annual Leave ☑', type: 'checkbox' },
      { key: 'leave.isSickLeave', label: 'Is Sick Leave ☑', type: 'checkbox' },
      { key: 'leave.isSpecialLeave', label: 'Is Special Leave ☑', type: 'checkbox' },
      { key: 'leave.isMaternityLeave', label: 'Is Maternity Leave ☑', type: 'checkbox' },
    ],
  },
  substitute: {
  ...
  manager: {
    ...
    fields: [
      { key: 'employee.manager', label: 'Manager Name', type: 'text' },
      { key: 'manager.name', label: 'Manager Name', type: 'text' },
  ...
  signature: {
    category: 'Signatures',
    fields: [
      { key: 'signature.employee.signature', label: 'Employee Signature', type: 'signature' },
      { key: 'signature.employee.name', label: 'Employee Name (Printed)', type: 'text' },
      { key: 'signature.employee.date', label: 'Employee Signature Date', type: 'date' },
      { key: 'signature.manager.signature', label: 'Manager Signature', type: 'signature' },
      { key: 'signature.manager.name', label: 'Manager Name (Printed)', type: 'text' },
      { key: 'signature.manager.date', label: 'Manager Signature Date', type: 'date' },
      { key: 'signature.director.signature', label: 'Director Signature', type: 'signature' },
      { key: 'signature.director.name', label: 'Director Name (Printed)', type: 'text' },
      { key: 'signature.director.date', label: 'Director Signature Date', type: 'date' },
      { key: 'signature.hr.signature', label: 'HR Signature', type: 'signature' },
      { key: 'signature.hr.name', label: 'HR Name (Printed)', type: 'text' },
      { key: 'signature.hr.date', label: 'HR Signature Date', type: 'date' },
      { key: 'signature.executive.signature', label: 'Executive Signature', type: 'signature' },
      { key: 'signature.executive.name', label: 'Executive Name (Printed)', type: 'text' },
      { key: 'signature.executive.date', label: 'Executive Signature Date', type: 'date' },
    ],
  },
};
