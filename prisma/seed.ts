...
async function main() {
  ...
  const leaveTypes = [
    ...
    },
    {
      ...
      requiresApproval: true,
      requiresDocument: false,
      description: 'Leave for moving to a new residence',
      isActive: true,
      maxDaysPerRequest: 1,
      isSpecialLeave: false,
      requiresHRVerification: false,
    ...
    {
      name: "Child's First School Day",
      code: 'CFSD',
      daysAllowed: 1,
      carryForward: false,
      requiresApproval: true,
      requiresDocument: false,
      description: "Leave for child's first day of school",
      isActive: true,
      maxDaysPerRequest: 1,
      isSpecialLeave: false,
      requiresHRVerification: false,
    ...
    // PROVISIONAL category (Conditional)
    {
