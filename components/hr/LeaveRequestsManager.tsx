              ...
              <div className="space-y-4">
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 flex gap-2">
                  ...
                  <p className="text-sm text-amber-800">
                    Editing this request will reset the approval chain to PENDING.
                    {editingRequest.status === "APPROVED" && " The approved balance will be reversed."}
                    {editingRequest.status === "REJECTED" && " This rejected request will be re-submitted for approval."}
                  </p>
                </div>
