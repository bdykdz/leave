...
import { Users, Loader2, Info, UserX } from "lucide-react"
  ...
  const fetchColleagues = async () => {
    try {
      ...
      const allColleagues = (data.substitutes || []).map((sub: any) => ({
        ...
        isVirtualUser: sub.isVirtualUser || false,
      }))
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-gray-500">
                    {colleague.isVirtualUser ? 'Fără înlocuitor disponibil' : colleague.role}
                  </div>
                </div>
